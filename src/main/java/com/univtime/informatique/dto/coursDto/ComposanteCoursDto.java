...
public class ComposanteCoursDto {
    ...
    public ComposanteCoursDto(Integer idComposante, String nomComposante, Integer volumeHoraireTotal, Integer volumeHoraireCM, Integer volumeHoraireTD, Integer volumeHoraireTP, Integer blocHoraireCM, Integer blocHoraireTD, Integer blocHoraireTP, ModuleComposanteDto moduleDto, Set<CMComposanteDto> cmDto, Set<TDComposanteDto> tdDto, Set<TPComposanteDto> tpDto, Set<BesoinSalleComposanteDto> besoinSalleDto) {
